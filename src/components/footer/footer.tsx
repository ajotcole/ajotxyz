  ...
  return (
    <footer className={styles.footerContainer}>
      ...
      <Panel isLightDismiss isOpen={isOpen} onDismiss={dismissPanel} type={PanelType.medium} headerText="Impressum">
        ...
        <h2>Kontakt</h2>
        <p>
          Telefon: +4915159826270
          <br />
          E-Mail: contact@ajot.xyz
        </p>
        ...
        <p>
          ...
          wir f&uuml;r diese fremden Inhalte auch keine Gew&auml;hr &uuml;bernehmen. F&uuml;r die Inhalte der verlinkten Seiten ist stets
          der jeweilige Anbieter oder Betreiber der Seiten verantwortlich. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf
          m&ouml;gliche Rechtsverst&ouml;&szlig;e &uuml;berpr&uuml;ft. Rechtswidrige Inhalte waren zum Zeitpunkt der Verlinkung nicht
          erkennbar.
        </p>{' '}
        <p>
        ...
        <p>
          ...
          bed&uuml;rfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads und Kopien dieser Seite sind nur
